...
def build_snapshot_v2_bundle() -> UnitSnapshotV2Bundle:
    ...
    if registry_unit_ids is not None:
        # Registry включён: Monitoring показывает только юниты, которые
        # присутствуют в Registry. Если там 0 записей, список будет пустой —
        # все новые устройства пойдут через Shadow/Inbox.
        unit_ids = base_unit_ids & registry_unit_ids
    else:
